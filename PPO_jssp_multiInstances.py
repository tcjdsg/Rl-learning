...
def main():
    ...
    envs = [JZJ(configs.n_j,configs.n_m) for _ in range(configs.num_envs)]
    ...
    for i_update in range(configs.max_updates):
        ...
        for i, env in enumerate(envs):
            fea, candidate = env.reset(data_generator(n_j=configs.n_j, n_m=configs.n_m, low=configs.low, high=configs.high))
